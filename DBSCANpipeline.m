...
if CaFrameQ == 1 
    CaEventFrame = input('What frame does the opto stim start? ');
    ...
    if genImQ == 1 
        ...
        for frame = 1:size(vesChan,3)   
            ...
            if frame >= CaEventFrame 
                ...
                hold on;
                if cropQ == 1 
                    scatter(edg_x,edg_y,100,'red','filled','square');    
                end 
            end 
            ax = gca;
            ax.Visible = 'off';
            ...
            filename = sprintf('%s/BBBsignal/frame%d',dir2,frame);
