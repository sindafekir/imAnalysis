...
%%IT'S HARD TO SEE IF ANYTHING IS HAPPENING PLOTTING PER TERMINAL RASTER
%%PLOTS (7 TRIALS IS NOT ENOUGH) NEXT MAKE A RASTER PLOT FOR ALL ANIMALS
%%STACKS ON TOP OF EACHOTHER 
