...
for mouse = 1:size(fileList,1)
    ...
    medISI = zeros(length(vidList),length(terminals));
...
%             sgtitle(label,'FontSize',25);     
            ...
            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            % PICK UP HERE 
            % determine the mean value of each bin in the histogram above 
            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
            
            % determine the median ISI per axon 
            medISI(vid,ccell) = median(ISIdiffsWholeExp{vid}{terminals(ccell)});
        end 
    end 
    
%     % plot median ISI (of each axon) distribution
%     figure
%     histogram(medISI,50,'FaceColor','k')
%     hold all 
%     ax=gca;
%     ax.FontSize = 15;
