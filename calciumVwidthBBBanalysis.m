...
for tType = 1:tTypeNum
    ...
    %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    %PICK UP HERE. FOR EACH FOR MOUSE and vid LOOP BELOW, NEED TO ADD IN
    ...
    for mouse = 1:mouseNum  
        ...
        %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        % PICK UP HERE. NEED TO REORGANIZE BELOW LOOPS SO THAT THE VID
        % ITERATION COMMENTED OUT BELOW MAKES SENSE. NEED TO USE CETA2 AS
        % VID COUNTER IN VID FOR LOOP
        
         
%         for vid = 1:length(Ceta2{mouse}{CaROIs{mouse}(CaROI)})  
%             if isempty(Ceta2{mouse}{CaROIs{mouse}(1)}{vid}{tTypeInds(tType)}) == 0 
                if tTypeInds(tType) == 1 || tTypeInds(tType) == 3  
                  if CAQ == 1                         
                    for CaROI = 1:size(CaROIs{mouse},2)
                        for vid = 1:length(Ceta2{mouse}{CaROIs{mouse}(CaROI)})  
                    ...
                    if BBBQ == 1                     
                        for BBBroi = 1:size(Beta{mouse},2)
                            for vid = 1:length(Beta2{mouse}{BBBroi})  
                                if isempty(Beta2{mouse}{BBBroi}{vid}{tTypeInds(tType)}) == 0        
                    ...
                    if VWQ == 1                     
                        for VWroi = 1:size(Veta{mouse},2)
                            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                            %@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                            %PICK UP HERE. NEED TO ADD IN VID ITERATION AND
...
%         end            
    ...
    for mouse = 1:mouseNum  
        if isempty(CetaArray1{mouse}{tTypeInds(tType)}) == 0 
