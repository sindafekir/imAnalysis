% organize data 
numPreStimPlumes_Pav = ([1,0,0]/3);
numStimPlumes_Pav = ([0,0,0]/3);
numPeriRewPlumes_Pav = ([4,1,1]/3);
numPostRewPlumes_Pav = ([2,1,1]/3);

numPreStimPlumes_Op = ([3,0,2,5,6]/5);
numStimPlumes_Op = ([0,1,4,9,8]/5);
numPeriRewPlumes_Op = ([6,3,4,1,9]/5);
numPostRewPlumes_Op = ([3,4,12,0,6]/5);
